...
export const contentConfigs: Record<EntityKind, ContentConfig> = {
  ...
  show: {
    ...
    eyebrow: "Published knowledge", description: "Production information, working links, and the history worth keeping.",
    ...
    fields: [
      ...
      { name: "producer", label: "Producer", type: "text", maxLength: 160 },
      { name: "network_brand", label: "Network / Brand", type: "text", maxLength: 160 },
      { name: "google_photos_url", label: "Google Photos", type: "url", placeholder: "https://photos.app.goo.gl/…", help: "The album stays in Google Photos; TIKI stores only this link." },
      ...
      { name: "summary", label: "Show Notes / Summary", type: "textarea", maxLength: 4000, wide: true },
  ...
  location: {
    ...
    fields: [
      ...
      { name: "postal_code", label: "Postal code", type: "text", maxLength: 40 },
      { name: "metro_area", label: "Metro area", type: "text", maxLength: 160 },
