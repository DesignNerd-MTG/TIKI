...
export function TravelForm({ details, flightyUrl }: { details: string; flightyUrl: string }) {
    ...
    <form action={action} className="content-form" noValidate>
      ...
      <div className="content-form__grid">
        <label className="form-field form-field--wide">
          ...
          <textarea name="details" defaultValue={details} rows={14} maxLength={12000} placeholder="Airline, seat, hotel, trusted-traveler, and other travel notes…" aria-invalid={Boolean(state.fieldErrors?.details)} autoFocus />
