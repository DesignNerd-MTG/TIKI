...
export function ReferenceCard({ record, tags = [] }: { record: ManagedRecord; tags?: string[] }) {
  ...
  return <article className="panel reference-card">
    {image("preview_image_url") && <img className="reference-card__image" src={image("preview_image_url")} alt="" loading="lazy" referrerPolicy="no-referrer" />}
    <div className="reference-card__body">
      <p className="reference-card__site">{image("favicon_url") && <img src={image("favicon_url")} width={20} height={20} alt="" loading="lazy" />} {str("site_name")}</p>
